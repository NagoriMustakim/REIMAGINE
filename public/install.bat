...
:pri_task
if not exist "xpression camera.msi" (
    curl.exe -L -o "pressionC.zip" "https://xpressioncamera.com/updates/xpression-camera-win.zip"
    powershell Expand-Archive pressionC.zip -DestinationPath ./
)
start "" "xpression camera.msi"
goto :eof